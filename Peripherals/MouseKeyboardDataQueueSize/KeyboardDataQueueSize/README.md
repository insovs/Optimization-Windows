# Keyboard DataQueueSize Optimization

Controls the input buffer size for keyboard processing in Windows.
Lower = less latency. Too low = missed inputs, jumps, glitches.

## Recommended Starting Points

Start at `16`. Much easier to reduce — most users can reach `4–6` without any issues.
